...
% PHASE-1 driver: coag=ON, disagg=OFF, PP=ON (explicit injection)
% ============================================================
...
% IMPORTANT with state_is_biovolume=true:
% pp_rate is interpreted as AREAL biovolume input [cm^3/cm^2/day]
cfg.pp_rate     = 0.1;
...
if isprop(cfg,'pp_bin'),      fprintf(fid, '  pp_bin       = %d\n', cfg.pp_bin); end
if isprop(cfg,'pp_layer'),    fprintf(fid, '  pp_layer     = %d\n', cfg.pp_layer); end
